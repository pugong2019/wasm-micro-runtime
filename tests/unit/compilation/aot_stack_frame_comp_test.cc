...
class aot_stack_frame_comp_test_suit : public testing::Test
{
  protected:
    virtual void SetUp() {}
...
TEST_F(aot_stack_frame_comp_test_suit, basic_stack_frame_compilation)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    ...
    // Test that compilation succeeds with stack frame operations
    // This validates that the stack frame compilation functions work correctly
...
TEST_F(aot_stack_frame_comp_test_suit, compilation_with_stack_management)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    ...
    // Test compilation with stack management operations
    // This validates stack frame compilation in different contexts
    
    aot_destroy_comp_context(comp_ctx);
    aot_destroy_comp_data(comp_data);
}

TEST_F(aot_stack_frame_comp_test_suit, compilation_with_frame_operations)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    ...
    // Test compilation with frame operations
    // This validates frame compilation with different stack configurations
