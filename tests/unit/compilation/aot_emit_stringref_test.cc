...
class aot_emit_stringref_test_suit : public testing::Test
{
  protected:
    virtual void SetUp() {}
...
TEST_F(aot_emit_stringref_test_suit, basic_stringref_compilation)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    ...
    // Test that compilation succeeds with stringref operations
    // This validates that the stringref emission functions work correctly
...
TEST_F(aot_emit_stringref_test_suit, compilation_with_string_operations)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    ...
    // Test compilation with string operations
    // This validates stringref emission with string manipulation
    
    aot_destroy_comp_context(comp_ctx);
    aot_destroy_comp_data(comp_data);
}

TEST_F(aot_emit_stringref_test_suit, compilation_with_encoding_operations)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    ...
    // Test compilation with encoding operations
    // This validates stringref emission with encoding/decoding
