...
class aot_emit_conversion_test_suit : public testing::Test
{
  protected:
    virtual void SetUp() {}
...
TEST_F(aot_emit_conversion_test_suit, basic_conversion_compilation)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    wasm_module_t wasm_module = nullptr;
    ...
    // Test that compilation succeeds with conversion operations
    // This validates that the conversion emission functions work correctly
...
TEST_F(aot_emit_conversion_test_suit, compilation_with_numeric_conversions)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    wasm_module_t wasm_module = nullptr;
    ...
    // Test compilation with numeric conversion operations
    // This validates conversion emission in different numeric contexts
...
TEST_F(aot_emit_conversion_test_suit, compilation_with_type_conversions)
{
    aot_comp_context_t comp_ctx = nullptr;
    aot_comp_data_t comp_data = nullptr;
    wasm_module_t wasm_module = nullptr;
    ...
    // Test compilation with type conversion operations
    // This validates conversion emission with different type systems
