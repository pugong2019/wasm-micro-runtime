...
1. **Generate test cases for current step (≤10 cases)**
   Create tests in `tests/unit/[ModuleName]/test_[step_name].cpp` and related CMakeLists.txt (If needed)
...
6. **Update [ModuleName]_coverage_improve_plan.md** with line-specific results
